                ...
                <div key={item.productId + (item.size || '') + (item.color || '')} className="flex items-start gap-4 p-4 border rounded-lg bg-card shadow">
                  ...
                  <div className="flex flex-col items-end gap-2">
                    <div className="flex items-center border rounded-md">
                      <Button variant="ghost" size="sm" className="px-2 h-8">-</Button>
                      <Input type="number" value={item.quantity} readOnly className="w-12 h-8 text-center border-0 focus-visible:ring-0 bg-transparent" />
                      <Button variant="ghost" size="sm" className="px-2 h-8">+</Button>
                    </div>
